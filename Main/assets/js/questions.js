var questions = [
    ...
    {
        question: "_____ JavaScript statements embedded in an HTML page can respond to user events such as mouse-clicks, form input, and ",
        choices: ["page navigation", "Client-side", "Server-side", "Local", "Native"],
        answer: "Client-side"
    },
    {
